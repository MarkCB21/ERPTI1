...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2016 a las 00:24:00
...
INSERT INTO `inventario` (`ID_Inve`, `ID_Categoria`, `Nombre`, `Precio`, `Fecha`) VALUES
(1, 1, 'Manzanas', 100, '2016-09-26');
...
CREATE TABLE `login_usuario` (
  ...
  `ID_D` int(30) DEFAULT NULL,
  `Tipo` enum('Admin','Cajero') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `login_usuario` (`ID_L`, `Nombre_cuenta`, `Contrasena`, `ID_D`, `Tipo`) VALUES
(1, 'root', '1234', 1, 'Admin');
...
--
ALTER TABLE `login_usuario`
  ADD CONSTRAINT `login_usuario_ibfk_1` FOREIGN KEY (`ID_D`) REFERENCES `datos` (`ID_D`);
