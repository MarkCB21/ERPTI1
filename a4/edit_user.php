...
mysqli_query($connection,"UPDATE login_usuario set Nombre_Cuenta='" . $_POST["Nombre_Cuenta"][$i] . "', Tipo='" . $_POST["Tipo"][$i] . "', Estado='" . $_POST["Estado"][$i] . "', ID_Datos='" . $_POST["ID_Datos"][$i] . "' WHERE ID_L='" . $_POST["ID_L"][$i] . "'");
}
