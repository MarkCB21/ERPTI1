...
<div id="contendor">
	...
	<div id="main">
		<form name="frmUser" method="post" action="">
			...
			<p>	<a href="list_data.php" style="text-decoration:none;" class="vpb_general_button">ver datos</a>
			<p>	<a href="member_register.php" style="text-decoration:none;" class="vpb_general_button">agregar nuevo usuario</a>
	</div>
</div>
</body></html>