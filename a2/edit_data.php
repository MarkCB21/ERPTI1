...
mysql_query("UPDATE datos set rut='" . $_POST["rut"][$i] . "', Nombres='" . $_POST["Nombres"][$i] . "', Apellidop='" . $_POST["Apellidop"][$i] . "', ApellidoM='" . $_POST["ApellidoM"][$i] . "', Correo='" . $_POST["Correo"][$i] . "', Telefono='" . $_POST["Telefono"][$i] . "', ID_direccion	='" . $_POST["ID_direccion	"][$i] . "' WHERE ID_Datos='" . $_POST["ID_Datos"][$i] . "'");
}
	...
	<?php
					if (!$_POST["data"]){
						...
						for($i=0;$i<$rowCount;$i++) {
							$result = mysql_query("SELECT * FROM datos WHERE ID_Datos='" . $_POST["data"][$i] . "'");
								...
								<td>
									<table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="tblSaveForm">
										<tr>
											...
											<td><input type="hidden" name="ID_Datos[]" class="txtField" value="<?php echo $row[$i]['ID_Datos']; ?>"><input type="number" min="1000000" name="rut[]" class="txtField" value="<?php echo $row[$i]['rut']; ?>"></td>
										</tr>
										<tr>
