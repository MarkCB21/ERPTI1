...
<div id="menu">
  <div id="logo"> 
    <a href="inicio.php"><img src="diseños/img/locatormedio.png" id="logo" ></a>
  </div>
  <div id="listas">
         <ul>
           <li><a href="inicio.php" title="CSS Menus" id="home">Dashboard</a></li>
           <li><a href="#" title="CSS Menus" class="current">Edit User</a></li>
           <?php
              //if($admin==true){
           ?>
           <li><a href="#" title="CSS Menus">Add User</a></li>
