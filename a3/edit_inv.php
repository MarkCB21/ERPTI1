...
mysqli_query($connection,"UPDATE inventario set ID_Categoria='" . $_POST["ID_Categoria"][$i] . "', Descripcion='" . $_POST["Descripcion"][$i] . "', Costo_Unitario='" . $_POST["Costo_Unitario"][$i] . "', Fecha_Entrada='" . $_POST["Fecha_Entrada"][$i] . "', Fecha_Salidas='" . $_POST["Fecha_Salidas"][$i] . "' WHERE ID_Inve='" . $_POST["ID_Inve"][$i] . "'");
}
