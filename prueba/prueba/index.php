...
<div  style="background-image: url(img/caja2.png); class=container;" >
  <img src="img/uctimagen.png" width=240 height=85 align="top">
    ...
    <form  action="process.php" method="POST"> 
        ...
        <tr>
			...
			<div align="center">
				...
				<br>
				<font size="2">Recordar nombre de usuario<input type="hidden" name="sublogin" value="1"><br>
