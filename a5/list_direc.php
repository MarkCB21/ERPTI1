...
<div id="contendor">
	...
	<div align="center" id="main">
			...
			<table border="0" cellpadding="10" cellspacing="1" width="500" class="tblListForm">
				...
				while($row = mysqli_fetch_array($result)) {
					...
					<tr class="<?php if(isset($classname)) echo $classname;?>">
						<td><input type="checkbox" name="dir[]" value="<?php echo $row["ID_Direccion"]; ?>" ></td>
		...
		<p>	<a href="list_comuna.php" style="text-decoration:none;" class="vpb_general_button"><button>ver comunas</button></a>
		<p>	<a href="add_direc.php" style="text-decoration:none;" class="vpb_general_button"><button>crear direcciones</button></a>
