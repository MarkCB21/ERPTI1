...
<div id="contendor">
	...
	<div align="center" id="main">
		...
		<form name="frmUser" method="post" action="">
			<table border="0" cellpadding="10" cellspacing="1" width="500" class="tblListForm">
				...
				<tr align="center" class="listheader">
					<td  colspan="4">
						<input type="button" name="update" value="Actualizar" onClick="setUpdateAction();" />
		...
		<form>
			...
			<p>	<a href="dato.php" style="text-decoration:none;" class="vpb_general_button"><button>crear nuevo dato</button></a>
