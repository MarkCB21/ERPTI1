...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2016 a las 19:43:02
...
--
ALTER TABLE `archivo`
  MODIFY `ID_Archivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
--
...
--
ALTER TABLE `compra_producto`
  MODIFY `ID_Compra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;
--
...
--
ALTER TABLE `total_compras`
  MODIFY `ID_total_compras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
--
